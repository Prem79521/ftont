                        ...
                        <Stepper activeStep={3}>
                            <div className="w-full glass">
                                ...
                                <form onSubmit={(e) => submitHandler(e)} autoComplete="off" className="flex flex-col justify-start gap-2 w-full mx-8 my-4 overflow-hidden">
                                    ...
                                    <input type="submit" value={`Pay ₹${totalPrice.toLocaleString()}`} disabled={payDisable ? true : false} className={`btn-primary w-1/2 sm:w-1/4 my-2 ${payDisable ? 'opacity-50 cursor-not-allowed' : ''}`} />
                                ...
                                <input ref={paymentBtn} type="submit" value="Pay" className="sm:w-1/3 my-2 text-sm uppercase outline-none cursor-pointer btn-primary w-full" />
                            </form> */}
                                {/* stripe form */}
