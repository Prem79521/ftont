                    ...
                    <>
                        {activeStep === index ? (
                            <div className="flex flex-col shadow rounded-sm">
                                <div className="flex items-center rounded-t-sm glass px-6 py-2 gap-4">
                                    <span className="h-5 w-5 flex items-center justify-center text-xs font-medium text-primary-blue glass">{index + 1}</span>
...
const Step = ({ isDesc, label, desc, index }) => {
    return (
        <div className="flex px-4 py-3 pb-4 glass">
