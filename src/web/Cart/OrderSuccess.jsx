    ...
    return (
        <>
            ...
            <main className="w-full mt-20">
                ...
                {/* <!-- row --> */}
                <div className="flex flex-col gap-2 items-center justify-center sm:w-4/6 sm:mt-4 m-auto mb-7 p-6 pb-12 glass">
                    ...
                    <p className="mt-4 text-lg">Redirecting to {success ? "orders" : "cart"} in {time} sec</p>
                    <Link to={success ? "/orders" : "/cart"} className="mt-2 uppercase btn-primary">go to {success ? "orders" : "cart"}</Link>
                </div>
                {/* <!-- row --> */}
