            ...
            {loading ? <Loader /> : (
                <>
                    ...
                    <main className="mt-12 sm:mt-0">
                        ...
                        <div className="w-full flex flex-col sm:flex-row sm:p-2 relative glass">
                            ...
                            <div className="w-full sm:w-2/5 sm:sticky top-16 sm:h-screen">
                                ...
                                <div className="flex flex-col gap-3 m-3">
                                    <div className="w-full h-full pb-6 border relative">
                                        ...
                                        <div className="absolute top-4 right-4 w-9 h-9 border flex items-center justify-center glass">
                                    ...
                                    <div className="w-full flex gap-3">
                                        {/* <!-- add to cart btn --> */}
                                        {product.stock > 0 && (
                                            <button onClick={itemInCart ? goToCart : addToCartHandler} className="btn-primary w-1/2 p-4 gap-2">
                                                <ShoppingCartIcon />
                                                {itemInCart ? "GO TO CART" : "ADD TO CART"}
                                            </button>
                                        )}
                                        <button onClick={buyNow} disabled={product.stock < 1 ? true : false} className={`btn-primary w-1/2 p-4 gap-2 ${product.stock < 1 ? 'w-full opacity-50 cursor-not-allowed' : ''}`}>
                                            <FlashOnIcon />
                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    <div className="w-full mt-4 rounded-sm border flex flex-col">
                                        <div className="flex justify-between items-center border-b px-6 py-4">
                                            ...
                                            <button onClick={handleDialogClose} className="btn-primary">Rate Product</button>
                                        </div>
                                        ...
                                        >
                                            ...
                                            <DialogActions>
                                                <button onClick={handleDialogClose} className="py-2 px-6 border border-red-500 hover:bg-red-100 text-red-600 uppercase glass">Cancel</button>
                                                <button onClick={reviewSubmitHandler} className="btn-primary uppercase py-2 px-6">Submit</button>
                                            </DialogActions>
                                        </Dialog>
                                        ...
                                        {product.reviews?.length > 3 &&
                                            <button onClick={() => setViewAll(!viewAll)} className="w-1/3 m-2 btn-primary">{viewAll ? "View Less" : "View All"}</button>
                                        }
                                    </div>
                                    {/* <!-- reviews border box --> */}
