                    ...
                    <div className="flex-1">
                        ...
                        {loading ? <Loader /> : (
                            <div className="flex flex-col gap-3 sm:mr-4 overflow-hidden">
                                ...
                                {/* <!-- searchbar --> */}
                                <form onSubmit={searchOrders} className="flex items-center justify-between mx-1 sm:mx-0 sm:w-10/12 border hover:shadow glass">
                                    ...
                                    <button type="submit" className="h-full text-sm sm:px-4 flex items-center gap-1 btn-primary">
                                ...
                                {orders && filteredOrders.length === 0 && (
                                    <div className="flex items-center flex-col gap-2 p-8 glass">
