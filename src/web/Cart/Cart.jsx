                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex flex-col glass">
                            ...
                            <div className="flex justify-end">
                                <button onClick={placeOrderHandler} disabled={cartItems.length < 1 ? true : false} className="btn-primary w-full sm:w-1/3 mx-2 sm:mx-6 my-4">PLACE ORDER</button>
                            </div>
                            {/* <!-- place order btn --> */}
                        ...
                        <div className="flex flex-col mt-5 glass">
