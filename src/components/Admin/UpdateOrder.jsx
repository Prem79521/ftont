                ...
                <>
                    {order && order.user && order.shippingInfo && (
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col sm:flex-row min-w-full glass">
                                ...
                                <form onSubmit={updateOrderSubmitHandler} className="flex flex-col gap-3 p-8">
                                    ...
                                    <button type="submit" className="p-2.5 btn-primary">
                                        Update
                                    </button>
                                </form>
                            </div>
                            ...
                            {order.orderItems && order.orderItems.map((item) => {
                                ...
                                return (
                                    <div className="flex flex-col sm:flex-row min-w-full px-2 py-5 glass" key={_id}>
