        ...
        <>
            ...
            <main className="w-full mt-12 sm:pt-20 sm:mt-0">
                ...
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 glass">
                    {/* <!-- sidebar column  --> */}
                    <div className="loginSidebar px-9 py-10 hidden sm:flex flex-col gap-4 w-2/5 border-r border-[#ffffff1a]">
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        <h2 className="text-center text-2xl font-medium mt-6">Update Profile</h2>
