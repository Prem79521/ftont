...
const UpdateProduct = () => {
    ...
    return (
        <>
            ...
            <form onSubmit={newProductSubmitHandler} encType="multipart/form-data" className="flex flex-col sm:flex-row p-4 glass" id="mainform">
                ...
                <div className="flex flex-col gap-3 m-2 sm:w-1/2">
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex justify-between items-center border rounded">
                            ...
                            <span onClick={() => addHighlight()} className="cursor-pointer btn-primary">Add</span>
                        </div>
                ...
                <div className="flex flex-col gap-2 m-2 sm:w-1/2">
                    ...
                    <div className="flex justify-evenly gap-2 items-center">
                        ...
                        <span onClick={() => addSpecs()} className="cursor-pointer btn-primary">Add</span>
                    </div>
                    ...
                    <div className="flex justify-end">
                        <input form="mainform" type="submit" className="uppercase w-1/3 p-3 cursor-pointer btn-primary" value="Update" />
                    </div>
