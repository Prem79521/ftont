                ...
                <div className="flex gap-3 mt-2 sm:mt-2 sm:mx-3 m-auto mb-7">
                    ...
                    <div className="flex-1">
                        ...
                        {!loading && products?.length === 0 && (
                            <div className="flex flex-col items-center justify-center gap-3 p-6 sm:p-16 glass">
                        ...
                        {loading ? <Loader /> : (
                            <div className="flex flex-col gap-2 pb-4 justify-center items-center w-full overflow-hidden glass">
