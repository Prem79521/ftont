            ...
            <div className="flex flex-col sm:flex-row gap-3.5 w-full sm:w-11/12 mt-0 sm:mt-4 m-auto sm:mb-7">
                ...
                <div className="flex-1">
                    ...
                    <Stepper activeStep={2}>
                        ...
                        <div className="flex justify-between items-center mt-4 px-6 py-3 glass">
                            <p className="text-sm">Order confirmation email will be sent to <span className="font-medium">{user.email}</span></p>
                            <button onClick={() => { navigate('/process/payment') }} className="uppercase btn-primary">continue</button>
                        </div>
                    </Stepper>
                </div>
